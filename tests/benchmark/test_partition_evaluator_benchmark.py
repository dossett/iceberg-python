...
# under the License.
"""Benchmark a single-value partition predicate when a prepared evaluator is shared across manifests.
...
def test_partition_evaluator_reuse(table_v2: Table, files_per_manifest: int) -> None:
    ...
    print(
        ...
        f"and a single-value predicate in "
